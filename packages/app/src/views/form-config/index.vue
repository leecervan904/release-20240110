  ...
  <div style="width: 400px">
    ...
    <Form ref="refForm" :model="form" :rules="rules" :label-width="140">
      ...
      <FormItem>
        ...
        <Button @click="handleClear" style="margin-left: 8px">Clear</Button>
      </FormItem>
    </Form>
  </div>
</template>
...
const initialForm = formConfigDemo.reduce((accu, curr) => {
  return {
    ...accu,
    [curr.prop]:
...
export default {
  ...
  data() {
    return {
      form: {},
      formList: formConfigDemo,
    };
  },
  computed: {
    rules() {
      return formConfigDemo.reduce((accu, curr) => {
        return {
          ...accu,
